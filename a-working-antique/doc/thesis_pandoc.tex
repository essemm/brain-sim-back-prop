...
\chapter*{Part 0: Synopsis}

\chapter{Chapter 0: Synopsis}
...
\begin{quote}\textit{The shortest distance between any two points is
always blocked. \textbf{Warren Monks, 1988}}\end{quote}
...
\section{1.2. So, What Is a Neural Network?}
...
\section{1.3. Neurological Relevance}
...
\section{1.4. Why and How do Neural Networks Solve Problems?}
...
\section{1.5. Types of Neural Networks}
...
\subsection{1.5.1. The Hopfield Network}
...
\subsection{1.5.2. The Back-Propagation Network}
...
\subsection{1.5.3. The ``Improved'' Neocognitron}
...
\subsection{1.5.4. The Adaptive Resonance Theory Model}
...
\section{1.6. Simulating Neural Networks in Hardware}
...
\section{1.7. Simulating Neural Networks in Software}
...
% ---- THESIS02.TEX ----
\chapter{Chapter 2: The Back-Propagation Model}
...
\section{2.1. The Maths Behind the Model}
...
\section{2.2. Modification of Weights}
...
\section{2.3. An Algorithm for The Back-Propagation Model}
...
% ---- THESIS03.TEX ----
\chapter*{Part 2: Software}

\begin{quote}\textit{\textbf{Allen's Law:} Everything is more complicated
than it appears.}\end{quote}

\chapter{Chapter 3: Software Specification}
...
\subsection{3.1.1. Selecting the Parameters -- Configuring the Network}
...
\subsubsection{3.1.1.1. Keyboard Input Format}
...
\subsubsection{3.1.1.2. Configuration File Format}
...
\subsection{3.1.2. Using a Pre-Made Network}
...
\subsubsection{3.1.2.1. Network File Format}
...
\subsection{3.1.3. Teaching Data}
...
\subsubsection{3.1.3.1. Teaching Data File Format}
...
\subsubsection{3.1.3.2. Expected Data File Format}
...
\subsubsection{3.1.4.1. Test Data File Format}
...
\subsubsection{3.1.4.2. Output Data File Format}
...
\subsection{3.1.5. Command Line Options}
...
\subsubsection{3.1.5.1. Screen Input/Output Control}

\paragraph{3.1.5.1.1. $-v$ (verbose) flag}
...
\paragraph{3.1.5.1.2. $-q$ (quiet) flag}
...
\subsubsection{3.1.5.2. Loading Configuration and Network Files from Disk}

\paragraph{3.1.5.2.1. $-c$ (load configuration file) directive}
...
\paragraph{3.1.5.2.2. $-n$ (load network file) directive}
...
\subsubsection{3.1.5.3. Using the Network File}

\paragraph{3.1.5.3.1. $-e$ (execute) flag}
...
\paragraph{3.1.5.3.2. $-t$ (teach) flag}
...
\subsubsection{3.1.5.4. Saving the Network File}

\paragraph{3.1.5.4.1. $-s$ (store ``taught'' network) flag}
...
\paragraph{3.1.5.4.2. $-d$ (don't store network) flag}
...
\paragraph{3.1.5.4.3. $-x$ (store learning information and time) flag}
...
\subsubsection{3.1.5.5. Calculation of $\Delta w(t)$}
...
\paragraph{3.1.5.5.1. $-1$ (each) mode}
...
\paragraph{3.1.5.5.2. $-a$ (all) mode}
...
\subsubsection{3.1.5.6. Printing the Help Message}

\paragraph{3.1.5.6.1. $-?$, $-h$ (help) flags}
...
\subsubsection{3.1.5.7. Unrecognised Options}
...
\subsubsection{3.1.5.8. Default (no options set)}
...
\section{3.2. Operations Performed}
...
\section{3.4. File Input/Output Format}
...
\chapter{Chapter 4: Software Construction}
...
\section{4.1. Data Structure Design}
...
\subsection{4.1.1. Network Structure}
...
\subsection{4.1.2. Structures Used in Back-Propagation Calculations}
...
\subsubsection{4.1.2.1. Temporary Values of $\partial E \over \partial x$}

Temporary values of $\partial E \over \partial x$ are stored in an
array of type \texttt{double}.

\subsubsection{4.1.2.2. Temporary Values of $\partial E \over \partial y$}

Temporary values of $\partial E \over \partial y$ are stored in an
array of type \texttt{double}.

\subsection{4.1.3. Input/Output Data Structures}
...
\subsubsection{4.1.3.1. Neuron's Input/Output Value}
...
\subsubsection{4.1.3.2. Input/Output Cases}
...
\subsection{4.1.4. General Data Structures}

\subsubsection{4.1.4.1. Data File Information}
...
\subsubsection{4.1.4.2. Most Commonly Used Parameters}
...
\subsubsection{4.1.4.3. Structure for Network Files}
...
\subsubsection{4.2.1.2. Allocating Space for The Network}
...
\subsubsection{4.2.1.3. Loading the Expected Data}
...
\subsubsection{4.2.1.4. Teaching the Network}
...
\subsubsection{4.2.1.5. Saving the Network}
...
\subsection{4.2.2. The Neural `Engine'}

\subsubsection{4.2.2.1. Operating With a Network}
...
\subsection{5.1.1. The (almost) Standard IBM-PC}
...
\subsection{5.1.2. The Turbo-Charging 8087}
...
\subsection{5.1.3. The Pyramid Super-Mini}
...
\section{5.2. Learning and Execution Speed}
...
\subsection{5.2.1. Learning Speed}
...
\subsection{5.2.2. Execution Speed}
...
\section{5.4. An Interesting Comparison --- Software versus Wetware}
...
% ---- THESIS06.TEX ----
\chapter*{Part 3: Using FishNET}

\chapter{Chapter 6: Introductory Experiments}
...
\section{6.1. The First Test --- O and X Recogniser}
...
\section{6.2. A More Ambitious Test --- Shadow Encoding}
...
\section{6.3. Dot Matrix Letter Encoding}
...
% ---- THESIS07.TEX ----
\chapter{Chapter 7: Experiments on learning}
...
\section{7.1. Variation of Learning Time with Parameters}
...
\section{7.2. Variation of Error Rate with Parameters}
...
% ---- THESIS08.TEX ----
\chapter{Chapter 8: Effects of casualties}
...
\section{8.1. Casualties in Connections}
...
\section{8.2. Casualties in Middle Layer Neurons}
...
\section{8.3. Mean Time Between Failure Analysis}
...
% ---- THESIS09.TEX ----
\chapter*{Part 4: Conclusions}

\begin{quote}\textit{This is not the end. It is not even the beginning
of the end. But it is, perhaps, the end of the beginning. \textbf{Winston Churchill, 1942}}\end{quote}
...
\section{9.1. Software -- Design and Performance}
...
\section{9.2. Possible Uses of FishNET}
...
\section{9.3. Behaviour of Neural Networks}
...
% ---- THESISA.TEX ----
\chapter*{Part 5: Appendices}

\chapter*{Appendix A: Software}
...
\section*{`C' Include Files}

\subsection*{fishNET.h}
...
\section*{The Help File --- help.hlp}
...
\section*{Expected Output Data}

\textit{[Listing: hugeout.dat]}

\section*{Data Used for Testing}
...
[6] Donald Hebb, ``The organization of behaviour,'' John Wiley, 
New York (1949).
...
[10] Teuvo Kohonen, ``The `Neural' Phonetic Typewriter,'' {\sl IEEE
...
[12] Jerome A. Feldman, Mark A. Fanty, and Nigel H. Goddard, ``Computing
with Structured Neural Networks,'' {\sl IEEE Computer} March 1988,
91--103.

[13] James A. Anderson, ``Networks for fun and profit,'' {\sl Nature
\bf322} (1986), 406--7.

[14] A paper by Amir F. Atiya, ``Learning on a general network,'' Department
...
[17] John J. Hopfield and David W. Tank, ``\thinspace`Neural'
Computation of Decisions in Optimization Problems,'' {\sl Biological
Cybernetics \bf52} (1985), 141--152.

[18] Ralph Linsker, ``Self-Organization in a Perceptual Network,'' {\sl
...
[21] Richard F. Lyon and Carver Mead, ``An Analog Electronic
...
[23] R. Paul Gorman and Terrence J. Sejnowski, ``Learned
...
[25] David J. Burr, ``Experiments on Neural Net Recognition of
...
[27] Thomas Plum and Jim Brodie, ``Efficient C,'' Plum Hall, Cardiff
New Jersey, 1985.
...
[29] Donald E. Knuth, ``The \TeX book,'' Addison Wesley, Sydney,
1986.
