...
QUESTION *
finput_parameters(char *file_name)
{
	QUESTION        *x;
...
LOAD_BOTH *
load_network_and_parameters(char *net_file)
{
	QUESTION        *parameter;
